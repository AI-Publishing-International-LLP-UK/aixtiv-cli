...
const anthropicOAuth = new OAuth2Client({
  ...
  tokenEndpoint:
    process.env.CLAUDE_OAUTH_TOKEN_ENDPOINT || 'https://auth.anthropic.com/oauth2/token',
  authEndpoint:
    process.env.CLAUDE_OAUTH_AUTH_ENDPOINT || 'https://auth.anthropic.com/oauth2/authorize',
