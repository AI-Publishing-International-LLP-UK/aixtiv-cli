...
const domainCommands = require('../commands/domain');
...
program
  ...
  .option('-s, --search <search>', 'Search for domains by name')
...
program
  ...
  .option('-t, --type <type>', 'Domain type (default: brand)')
  .option('-p, --project <project>', 'Firebase project ID (default: api-for-warp-drive)')
  .option('-s, --ssl', 'Provision SSL certificates after import')
  .action(domainCommands.importDomains);
...
program
  ...
  .action(domainCommands.checkSsl);

program
  .command('domain:provision-ssl <file>')
  .description('Provision SSL certificates for domains')
  .option('-t, --type <type>', 'Provision type (firebase or gcp) (default: firebase)')
  .option('-p, --project <project>', 'Project ID (default: api-for-warp-drive)')
  .option('--dry-run', 'Dry run - show commands without executing')
  .action(domainCommands.provisionSsl);

program
  .command('domain:clean-cache <godaddy-file>')
  .description('Clean domain cache by verifying against GoDaddy domains')
  .action(domainCommands.cleanCache);
