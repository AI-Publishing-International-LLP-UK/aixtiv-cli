  ...
  return class Page extends _classSuper {
    ...
    constructor() {
      ...
      (0, util_js_1.fromEmitterEvent)(this, 'request' /* PageEvent.Request */)
        .pipe(
          (0, rxjs_js_1.mergeMap)((originalRequest) => {
            return (0, rxjs_js_1.concat)(
              (0, rxjs_js_1.of)(1),
              (0, rxjs_js_1.merge)(
                (0, util_js_1.fromEmitterEvent)(
                  this,
                ...
                (0, util_js_1.fromEmitterEvent)(this, 'response' /* PageEvent.Response */).pipe(
                  (0, rxjs_js_1.map)((response) => {
                    return response.request();
                  })
                )
              ).pipe(
                (0, rxjs_js_1.filter)((request) => {
          ...
          (0, rxjs_js_1.takeUntil)(
            (0, util_js_1.fromEmitterEvent)(this, 'close' /* PageEvent.Close */)
          ),
          (0, rxjs_js_1.startWith)(0)
        )
    ...
    async evaluateHandle(pageFunction, ...args) {
      pageFunction = (0, util_js_1.withSourcePuppeteerURLIfNone)(
    ...
    waitForRequest(urlOrPredicate, options = {}) {
      ...
      const observable$ = (0, util_js_1.fromEmitterEvent)(
        this,
        'request' /* PageEvent.Request */
      ).pipe(
        (0, util_js_1.filterAsync)(urlOrPredicate),
        (0, rxjs_js_1.raceWith)(
          (0, util_js_1.timeout)(ms),
          (0, util_js_1.fromAbortSignal)(signal),
          (0, util_js_1.fromEmitterEvent)(this, 'close' /* PageEvent.Close */).pipe(
            (0, rxjs_js_1.map)(() => {
    ...
    waitForNetworkIdle$(options = {}) {
      ...
      return this.#inflight$.pipe(
        (0, rxjs_js_1.switchMap)((inflight) => {
    ...
    async waitForFrame(urlOrPredicate, options = {}) {
      ...
      const predicate = (0, util_js_1.isString)(urlOrPredicate)
        ...
        : urlOrPredicate;
      return await (0, rxjs_js_1.firstValueFrom)(
        (0, rxjs_js_1.merge)(
          (0, util_js_1.fromEmitterEvent)(this, 'frameattached' /* PageEvent.FrameAttached */),
          (0, util_js_1.fromEmitterEvent)(this, 'framenavigated' /* PageEvent.FrameNavigated */),
          (0, rxjs_js_1.from)(this.frames())
        ).pipe(
          (0, util_js_1.filterAsync)(predicate),
          (0, rxjs_js_1.first)(),
          (0, rxjs_js_1.raceWith)(
            (0, util_js_1.timeout)(ms),
            (0, util_js_1.fromAbortSignal)(signal),
    ...
    async screenshot(userOptions = {}) {
      ...
      try {
        ...
        const stack = __addDisposableResource(
          env_2,
          new disposable_js_1.AsyncDisposableStack(),
          true
        );
        if (options.clip) {
          if (options.fullPage) {
    ...
    /** @internal */
    [((_screenshot_decorators = [
      (0, decorators_js_1.guarded)(function () {
        return this.browser();
      }),
    ]),
