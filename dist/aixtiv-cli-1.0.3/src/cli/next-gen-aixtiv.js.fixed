...
registerCommand(
  ...
  async (options, { spinner }) => {
    ...
    const domains = [
      { name: 'coaching2100.com', type: 'brand', status: 'active', expiryDate: '2026-04-20', firebaseProject: 'coaching2100-com' },
      { name: 'drlucy.live', type: 'character', status: 'active', expiryDate: '2026-02-15', firebaseProject: 'dr-lucy-live' },
      { name: 'drmatch.live', type: 'character', status: 'active', expiryDate: '2026-02-15', firebaseProject: 'dr-match-live' },
      { name: 'drclaude.live', type: 'character', status: 'active', expiryDate: '2026-03-10', firebaseProject: 'dr-claude-live' },
      { name: 'anthology-ai.com', type: 'brand', status: 'active', expiryDate: '2026-05-18', firebaseProject: 'anthology-ai-com' },
      { name: 'aixtiv.com', type: 'brand', status: 'active', expiryDate: '2026-04-30', firebaseProject: 'aixtiv-com' },
      { name: 'test-domain.org', type: 'brand', status: 'pending', expiryDate: '2026-01-01', firebaseProject: 'test-domain-org' }
    ];
