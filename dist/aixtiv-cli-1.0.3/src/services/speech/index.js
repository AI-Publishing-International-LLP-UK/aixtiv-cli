...
module.exports = {
  ...
  setPersonalization: async (userId, copilotId, settings) => speechCore.setPersonalization(userId, copilotId, settings),
  
  // Speaker recognition functions
  createSpeakerProfile: async (userId, profileData) => speakerRecognition.createProfile(userId, profileData),
  enrollSpeaker: async (profileId, audio, phrase) => speakerRecognition.enrollSpeaker(profileId, audio, phrase),
  verifySpeaker: async (profileId, audio, phrase) => speakerRecognition.verifySpeaker(profileId, audio, phrase),
  identifySpeaker: async (audio, profileIds) => speakerRecognition.identifySpeaker(audio, profileIds),
