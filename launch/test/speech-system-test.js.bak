...
async function testCEScoring() {
  ...
  try {
    ...
    const positiveUpdate = await speechService.updateCEScore(
      USERS.PCR,
      5,
      'Positive test interaction'
    );
    ...
    const negativeUpdate = await speechService.updateCEScore(
      USERS.PCR,
      -3,
      'Negative test interaction'
    );
