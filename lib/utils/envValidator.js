...
const ENV_SCHEMA = {
  ...
  LANGCHAIN_01_KEY: {n    required: false,n    errorType: ERROR_TYPES.WARNING,n    description: 'LangChain 01 API key',n    validator: (value) => {n      // Just ensure it's a non-empty stringn      return !!value;n    },n    errorMessage: 'Empty or missing value'n  },n  LANGCHAIN_02_KEY: {n    required: false,n    errorType: ERROR_TYPES.WARNING,n    description: 'LangChain 02 API key',n    validator: (value) => {n      // Just ensure it's a non-empty stringn      return !!value;n    },n    errorMessage: 'Empty or missing value'n  },    required: true,
    errorType: ERROR_TYPES.CRITICAL,
