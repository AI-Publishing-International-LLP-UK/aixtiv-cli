          ...
          <nav>
            <ul className="nav-list">
              ...
              <li className={`nav-item ${activeTab === 'agents' ? 'active' : ''}`}>
                <a href="#" onClick={() => setActiveTab('agents')}>
                  Agents
                </a>
              </li>
              <li className={`nav-item ${activeTab === 'dewey' ? 'active' : ''}`}>
                <a href="#" onClick={() => setActiveTab('dewey')}>
                  Dewey Cards
                </a>
              </li>
              <li className={`nav-item ${activeTab === 's2do' ? 'active' : ''}`}>
                <a href="#" onClick={() => setActiveTab('s2do')}>
                  S2DO Workflow
                </a>
              </li>
              <li className={`nav-item ${activeTab === 'analytics' ? 'active' : ''}`}>
                <a href="#" onClick={() => setActiveTab('analytics')}>
                  Analytics
                </a>
              </li>
            </ul>
      ...
      <main className="container">
        ...
        {activeTab === 's2do' && (
          <>
            ...
            <p>
              The S2DO (Scan-to-Do) workflow system manages task approvals and blockchain
              integration.
            </p>
        ...
        <div className="container">
          <div className="footer-content">
            <div className="footer-section">
              <h3>About ASOOS</h3>
              <p>
                ASOOS (Aixtiv Symphony Orchestrating Operating System) is a modular, agent-driven
                enterprise solution for orchestrating AI workflows and human collaboration.
              </p>
            </div>
            <div className="footer-section">
              <h3>Quick Links</h3>
            ...
            <div className="footer-section">
              <h3>Contact</h3>
              <p>
                For assistance, please contact your agent representative or system administrator.
              </p>
            </div>
          </div>
