...
function versionCommand() {
  ...
  console.log('\nASOOS Components:');
  console.log(`${DOMAIN_STYLES.sallyport.icon} ${DOMAIN_STYLES.sallyport.color('SallyPort Security')}: v1.0.2`);
  console.log(`${DOMAIN_STYLES.wing.icon} ${DOMAIN_STYLES.wing.color('Wing Orchestration')}: v1.1.0`);
  console.log(`${DOMAIN_STYLES.claude.icon} ${DOMAIN_STYLES.claude.color('Dr. Claude Commands')}: v1.0.5`);
  console.log(`${DOMAIN_STYLES.domain.icon} ${DOMAIN_STYLES.domain.color('Domain Management')}: v1.2.1`);
