...
# Connect to GKE cluster and get STAGING_IP
echo -e "${YELLOW}[CONFIG] Connecting to Kubernetes cluster to retrieve STAGING_IP${NC}"
...
SUBSTITUTIONS="_DEPLOY_ENV=staging,_TRIGGER_SOURCE=manual,STAGING_IP=$STAGING_IP"
...
# Submit the build with STAGING_IP as a substitution variable
